...
const testimonials = [
    {
        ...
        quote: "Learnify-AI has transformed the way I study. The AI teacher is incredibly helpful for clarifying complex topics, and I love being able to re-watch lectures whenever I need to."
    },
    {
        name: "Arjun Mehta",
        role: "BCA Student",
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg sm:text-xl text-foreground/80">
              Learnify-AI provides a seamless virtual classroom experience with an AI Teacher, ensuring your learning never stops.
            </p>
       ...
       <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                ...
                <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">Discover the features that make Learnify-AI the most advanced virtual classroom for BCA students.</p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-card border-y">
         <div className="container mx-auto px-4 sm:px-6 lg:px-8">
             <div className="text-center mb-12">
                ...
                <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">See what our students have to say about their experience with Learnify-AI.</p>
            </div>
       ...
       <section className="py-20 md:py-32 bg-background">
           <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
                    Join thousands of students and unlock your full potential with Learnify-AI. Register today and experience the future of education.
                </p>
                <div className="mt-8">
                     <Button size="lg" asChild>
